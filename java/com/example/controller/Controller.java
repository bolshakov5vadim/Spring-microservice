...
import com.example.demo.entity.MyEntity;//название файла. подключили сущность 
import com.example.demo.repository.MyRepository;//название файла. подключили репозиторий
